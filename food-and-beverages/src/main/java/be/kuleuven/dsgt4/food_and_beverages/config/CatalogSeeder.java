...
public class CatalogSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        products.saveAll(List.of(
                new Product("F-001", "Nachos", "Sharing portion", new BigDecimal("6.50"), 200, Category.FOOD),
                new Product("F-002", "Loaded fries", "With cheese & bacon", new BigDecimal("7.00"), 180, Category.FOOD),
                new Product("F-003", "Veggie wrap", "Falafel & hummus", new BigDecimal("8.50"), 120, Category.FOOD),
                new Product("D-001", "Trappist beer", "33cl bottle", new BigDecimal("4.00"), 500, Category.DRINK),
                new Product("D-002", "Cola", "33cl can", new BigDecimal("2.50"), 800, Category.DRINK),
                new Product("D-003", "Sparkling water", "50cl bottle", new BigDecimal("3.00"), 600, Category.DRINK)
        ));
